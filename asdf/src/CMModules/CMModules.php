<?php
/**
 * A model for managing Asdf modules.
 * 
 * @package AsdfCore
 */
class CMModules extends CObject {
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isAsdfCore']   = in_array($rc->name, $this->asdfCoreModules);
      $details['isAsdfCMF']    = in_array($rc->name, $this->asdfCMFModules);
